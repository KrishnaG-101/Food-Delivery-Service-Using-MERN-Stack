    ...
    <div className='login-pop-up'>
      <form className='login-pop-up-container' onSubmit={onLogin}>
         ...
         <div className='login-popup-inputs'>
            ...
            <input name='email' onChange={onChangeHandler} value={data.email} type="email" placeholder='Emter your email' required />
            <input name='password' onChange={onChangeHandler} value={data.password} type="password" placeholder='Emter your password' required />
         </div>
